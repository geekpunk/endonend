...
- **MVP validation threshold.** Still open. How many artists and/or labels need to be onboarded to the reference instance to meaningfully validate the MVP, and what signals beyond raw count indicate the model is actually working for them.
